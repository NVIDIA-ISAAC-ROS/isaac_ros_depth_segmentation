...
class Bi3DInference : public gxf::Codelet {
 public:
  Bi3DInference()  = default;
  ~Bi3DInference() = default;
 ...
 private:
  ...
  bi3d::ModelInputParams modelInputParams;
  ...
  bi3d::Bi3D::Bi3DParams extraParams;
  // cvcore Bi3D object
  std::unique_ptr<bi3d::Bi3D> objBi3D;
  cvcore::tensor_ops::Array<int> disparityValues;
  ...
  // Data allocator to forward the disparity array
  gxf::Parameter<gxf::Handle<gxf::Allocator>> forward_pool_;
